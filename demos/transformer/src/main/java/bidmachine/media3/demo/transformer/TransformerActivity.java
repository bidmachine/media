...
import bidmachine.media3.demo.transformer.R;
import bidmachine.media3.common.C;
import bidmachine.media3.common.DebugViewProvider;
...
import bidmachine.media3.common.util.BitmapLoader;
import bidmachine.media3.common.util.GlUtil;
import bidmachine.media3.common.util.Log;
import bidmachine.media3.datasource.DataSourceBitmapLoader;
import bidmachine.media3.effect.BitmapOverlay;
import bidmachine.media3.effect.Contrast;
import bidmachine.media3.effect.DrawableOverlay;
import bidmachine.media3.effect.GlEffect;
import bidmachine.media3.effect.GlShaderProgram;
import bidmachine.media3.effect.HslAdjustment;
import bidmachine.media3.effect.OverlayEffect;
import bidmachine.media3.effect.OverlaySettings;
import bidmachine.media3.effect.Presentation;
import bidmachine.media3.effect.RgbAdjustment;
import bidmachine.media3.effect.RgbFilter;
import bidmachine.media3.effect.RgbMatrix;
import bidmachine.media3.effect.ScaleAndRotateTransformation;
import bidmachine.media3.effect.SingleColorLut;
import bidmachine.media3.effect.TextOverlay;
import bidmachine.media3.effect.TextureOverlay;
import bidmachine.media3.exoplayer.ExoPlayer;
import bidmachine.media3.exoplayer.audio.SilenceSkippingAudioProcessor;
import bidmachine.media3.exoplayer.util.DebugTextViewHelper;
import bidmachine.media3.transformer.Composition;
import bidmachine.media3.transformer.DefaultEncoderFactory;
import bidmachine.media3.transformer.DefaultMuxer;
import bidmachine.media3.transformer.EditedMediaItem;
import bidmachine.media3.transformer.EditedMediaItemSequence;
import bidmachine.media3.transformer.Effects;
import bidmachine.media3.transformer.ExportException;
import bidmachine.media3.transformer.ExportResult;
import bidmachine.media3.transformer.ProgressHolder;
import bidmachine.media3.transformer.TransformationRequest;
import bidmachine.media3.transformer.Transformer;
import bidmachine.media3.ui.AspectRatioFrameLayout;
import bidmachine.media3.ui.PlayerView;
...
public final class TransformerActivity extends AppCompatActivity {
  ...
  private ImmutableList<Effect> createVideoEffectsFromBundle(Bundle bundle)
    ...
    if (selectedEffects[ConfigurationActivity.EDGE_DETECTOR_INDEX]) {
      try {
        Class<?> clazz = Class.forName("bidmachine.media3.demo.transformer.MediaPipeProcessor");
