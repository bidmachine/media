...
/* package */ class MediaLibraryServiceLegacyStub extends MediaSessionServiceLegacyStub {
  ...
  public BrowserRoot onGetRoot(
    ...
    if (result != null && result.resultCode == LibraryResult.RESULT_SUCCESS && result.value != null) {
      @Nullable
      Bundle extras =
    ...
    return result != null && result.resultCode != LibraryResult.RESULT_SUCCESS
        ? null
        ...
        () -> {
          try {
            ...
            result.sendResult(
                (mediaItems == null)
                    ? null
                    : MediaUtils.truncateListBySize(mediaItems, MediaUtils.TRANSACTION_SIZE_LIMIT_IN_BYTES));
          } catch (CancellationException | ExecutionException | InterruptedException e) {
            Log.w(TAG, "Library operation failed", e);
            result.sendError(/* extras= */ null);
          }
  ...
  private AsyncFunction<
    ...
    return result -> {
      ...
      if (result.resultCode != LibraryResult.RESULT_SUCCESS || result.value == null) {
  ...
  private final class BrowserLegacyCb implements ControllerCb {
    ...
    public void onChildrenChanged(
        int seq, String parentId, int itemCount, @Nullable MediaLibraryService.LibraryParams params)
    ...
    public void onSearchResultChanged(
        int seq, String query, int itemCount, @Nullable MediaLibraryService.LibraryParams params)
        throws RemoteException {
  ...
  private final class BrowserLegacyCbForBroadcast implements ControllerCb {
    ...
    @Override
    public void onChildrenChanged(
        int seq, String parentId, int itemCount, @Nullable MediaLibraryService.LibraryParams libraryParams)
        throws RemoteException {
