...
import static bidmachine.media3.common.util.Util.postOrRun;
import static bidmachine.media3.common.util.Util.postOrRunWithCompletion;
import static bidmachine.media3.common.util.Util.transformFutureAsync;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_CUSTOM;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_LIBRARY_GET_CHILDREN;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_LIBRARY_GET_ITEM;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_LIBRARY_GET_LIBRARY_ROOT;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_LIBRARY_GET_SEARCH_RESULT;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_LIBRARY_SEARCH;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_LIBRARY_SUBSCRIBE;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_LIBRARY_UNSUBSCRIBE;
import static bidmachine.media3.session.SessionCommand.COMMAND_CODE_SESSION_SET_RATING;
...
import bidmachine.media3.common.BundleListRetriever;
import bidmachine.media3.common.C;
import bidmachine.media3.common.MediaItem;
import bidmachine.media3.common.MediaLibraryInfo;
...
import bidmachine.media3.common.Rating;
import bidmachine.media3.common.TrackGroup;
import bidmachine.media3.common.TrackSelectionOverride;
...
import bidmachine.media3.common.util.BundleableUtil;
import bidmachine.media3.common.util.Consumer;
import bidmachine.media3.common.util.Log;
import bidmachine.media3.common.util.Util;
import bidmachine.media3.session.MediaSession.ControllerCb;
import bidmachine.media3.session.MediaSession.ControllerInfo;
import bidmachine.media3.session.MediaSession.MediaItemsWithStartPosition;
import bidmachine.media3.session.SessionCommand.CommandCode;
 ...
 * both {@link MediaSession} and {@link MediaLibraryService.MediaLibrarySession}.
 */
...
/* package */ final class MediaSessionStub extends IMediaSession.Stub {
  ...
  public void getLibraryRoot(
    ...
    MediaLibraryService.LibraryParams libraryParams =
        libraryParamsBundle == null ? null : MediaLibraryService.LibraryParams.CREATOR.fromBundle(libraryParamsBundle);
    dispatchSessionTaskWithSessionCommand(
        caller,
        sequenceNumber,
  ...
  /* package */ static final class Controller2Cb implements ControllerCb {
    ...
    public void onChildrenChanged(
        int sequenceNumber, String parentId, int itemCount, @Nullable MediaLibraryService.LibraryParams params)
        throws RemoteException {
    ...
    public void onSearchResultChanged(
        int sequenceNumber, String query, int itemCount, @Nullable MediaLibraryService.LibraryParams params)
        throws RemoteException {
