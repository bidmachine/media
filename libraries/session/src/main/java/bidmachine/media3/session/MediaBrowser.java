...
import static bidmachine.media3.common.util.Assertions.checkNotEmpty;
...
public final class MediaBrowser extends MediaController {
  ...
  public interface Listener extends MediaController.Listener {
     ...
     *     params} that you've specified with {@link #subscribe(String, MediaLibraryService.LibraryParams)}.
     */
     ...
     * MediaBrowser#search(String, MediaLibraryService.LibraryParams)}.
     *
     * @param browser The browser for this event.
     ...
     * @param params The optional parameters from the library service. Can be differ from the {@code
     *     params} that you've specified with {@link #search(String, MediaLibraryService.LibraryParams)}.
     */
   ...
   * Listener#onChildrenChanged(MediaBrowser, String, int, MediaLibraryService.LibraryParams)} will be called with the
   * {@link MediaLibraryService.LibraryParams}. You may call {@link #getChildren(String, int, int, MediaLibraryService.LibraryParams)} to
   * get the children.
   *
  ...
  public ListenableFuture<LibraryResult<Void>> subscribe(
      String parentId, @Nullable MediaLibraryService.LibraryParams params) {
    verifyApplicationThread();
   ...
   * {@link #subscribe(String, MediaLibraryService.LibraryParams)}.
   *
   * <p>This unsubscribes from all previous subscriptions with the parent id, regardless of the
   * {@link MediaLibraryService.LibraryParams} that was previously given.
   *
   ...
   * String, int, MediaLibraryService.LibraryParams)} and call {@link #getSearchResult(String, int, int,
   * MediaLibraryService.LibraryParams)}}.
   *
  ...
  public ListenableFuture<LibraryResult<Void>> search(
      String query, @Nullable MediaLibraryService.LibraryParams params) {
    verifyApplicationThread();
  ...
  /* package */ interface MediaBrowserImpl extends MediaControllerImpl {
    ...
    ListenableFuture<LibraryResult<MediaItem>> getLibraryRoot(@Nullable MediaLibraryService.LibraryParams rootHints);
    ...
    ListenableFuture<LibraryResult<ImmutableList<MediaItem>>> getChildren(
        String parentId, int page, int pageSize, @Nullable MediaLibraryService.LibraryParams params);

    ListenableFuture<LibraryResult<MediaItem>> getItem(String mediaId);

    ListenableFuture<LibraryResult<Void>> search(String query, @Nullable MediaLibraryService.LibraryParams params);

    ListenableFuture<LibraryResult<ImmutableList<MediaItem>>> getSearchResult(
        String query, int page, int pageSize, @Nullable MediaLibraryService.LibraryParams params);
  }
}
