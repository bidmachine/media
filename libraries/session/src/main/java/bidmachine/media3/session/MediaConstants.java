...
public final class MediaConstants {
   ...
   * LibraryResult#ofError(int, MediaLibraryService.LibraryParams) creating a library result} for an unsuccessful
   * service call.
   *
   ...
   *
   * <p>Use this key to populate the extras bundle of the {@link MediaLibraryService.LibraryParams} when {@linkplain
   * LibraryResult#ofError(int, MediaLibraryService.LibraryParams) creating a library result} for an unsuccessful
   * service call.
   */
   ...
   * Player#COMMAND_SEEK_TO_NEXT} by design.
   *
   ...
   * @see Player#COMMAND_SEEK_TO_NEXT_MEDIA_ITEM
   */
   ...
   *
   * <p>This may be used when the session temporarily disallows {@link
   * Player#COMMAND_SEEK_TO_PREVIOUS} by design.
   *
   * @see MediaSession#setSessionExtras(Bundle)
   * @see MediaSessionCompat#setExtras(Bundle)
   * @see MediaController.Listener#onExtrasChanged(MediaController, Bundle)
   ...
   * @see Player#COMMAND_SEEK_TO_PREVIOUS_MEDIA_ITEM
   */
   ...
   *
   * <p>If exposed through {@link MediaLibraryService.LibraryParams#extras} of the {@link LibraryResult} returned by
   ...
   * MediaBrowser#getLibraryRoot(MediaLibraryService.LibraryParams)}.
   *
   * <p>TYPE: int. Possible values are separate constants.
   *
   * @see MediaBrowser#getLibraryRoot(MediaLibraryService.LibraryParams)
  ...
  /**
   * {@link Bundle} key used in {@link MediaLibraryService.LibraryParams#extras} passed to {@link
   * MediaLibraryService.MediaLibrarySession.Callback#onGetLibraryRoot(MediaLibraryService.MediaLibrarySession, MediaSession.ControllerInfo,
   * MediaLibraryService.LibraryParams)} to indicate the maximum number of children of the root node that can be
   * supported by the {@link MediaBrowser}. Excess root children may be omitted or made less
   * discoverable.
   *
   * <p>TYPE: int
   *
   * @see MediaLibraryService.MediaLibrarySession.Callback#onGetLibraryRoot(MediaLibraryService.MediaLibrarySession,
   *     MediaSession.ControllerInfo, MediaLibraryService.LibraryParams)
   * @see MediaBrowser#getLibraryRoot(MediaLibraryService.LibraryParams)
   * @see MediaLibraryService.LibraryParams#extras
   */
  @UnstableApi
   ...
   * {@link Bundle} key used in {@link MediaLibraryService.LibraryParams#extras} passed to {@link
   * MediaLibraryService.MediaLibrarySession.Callback#onGetLibraryRoot(MediaLibraryService.MediaLibrarySession, MediaSession.ControllerInfo,
   * MediaLibraryService.LibraryParams)} to indicate whether only browsable media items are supported as children of the
  ...
  public static final String EXTRA_KEY_ROOT_CHILDREN_BROWSABLE_ONLY =
      "bidmachine.media3.session.LibraryParams.Extras.KEY_ROOT_CHILDREN_BROWSABLE_ONLY";

  /**
   * {@link Bundle} key used in {@link MediaLibraryService.LibraryParams#extras} passed by the {@link MediaBrowser} as
   * root hints to {@link MediaLibraryService.MediaLibrarySession.Callback#onGetLibraryRoot(MediaLibraryService.MediaLibrarySession,
   * MediaSession.ControllerInfo, MediaLibraryService.LibraryParams)} to indicate the recommended size, in pixels, for
   ...
   *
   * <p>Use this key to populate the {@link MediaLibraryService.LibraryParams#extras} of the {@link LibraryResult}
   * returned by {@link MediaLibraryService.MediaLibrarySession.Callback#onGetLibraryRoot(MediaLibraryService.MediaLibrarySession,
   * MediaSession.ControllerInfo, MediaLibraryService.LibraryParams)}. Use this key with {@link
  ...
  public static final String EXTRAS_KEY_MEDIA_TYPE_COMPAT =
      "bidmachine.media3.session.EXTRAS_KEY_MEDIA_TYPE_COMPAT";

  /* package */ static final String SESSION_COMMAND_ON_CAPTIONING_ENABLED_CHANGED =
      "bidmachine.media3.session.SESSION_COMMAND_ON_CAPTIONING_ENABLED_CHANGED";
  /* package */ static final String SESSION_COMMAND_REQUEST_SESSION3_TOKEN =
      "bidmachine.media3.session.SESSION_COMMAND_REQUEST_SESSION3_TOKEN";

  /* package */ static final String ARGUMENT_CAPTIONING_ENABLED =
      "bidmachine.media3.session.ARGUMENT_CAPTIONING_ENABLED";
