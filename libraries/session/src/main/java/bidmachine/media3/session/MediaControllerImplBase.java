...
import static bidmachine.media3.common.util.Assertions.checkIndex;
...
import bidmachine.media3.common.Timeline.RemotableTimeline;
...
import bidmachine.media3.session.MediaController.MediaControllerImpl;
    ...
    playerInfo =
        playerInfo.copyWithSessionPositionInfo(
            new SessionPositionInfo(
                ...
                /* bufferedPercentage= */ MediaUtils.calculateBufferedPercentage(
