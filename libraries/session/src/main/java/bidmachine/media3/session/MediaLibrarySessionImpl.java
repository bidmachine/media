...
import bidmachine.media3.session.R;
...
/* package */ class MediaLibrarySessionImpl extends MediaSessionImpl {
  ...
  private static final String RECENT_LIBRARY_ROOT_MEDIA_ID = "bidmachine.media3.session.recent.root";
  ...
  public MediaLibrarySessionImpl(
      MediaLibraryService.MediaLibrarySession instance,
      Context context,
      String id,
      Player player,
  ...
  public List<MediaSession.ControllerInfo> getConnectedControllers() {
    List<MediaSession.ControllerInfo> list = super.getConnectedControllers();
  ...
  @Override
  public boolean isConnected(MediaSession.ControllerInfo controller) {
  ...
  public void notifyChildrenChanged(
      String parentId, int itemCount, @Nullable MediaLibraryService.LibraryParams params) {
  ...
  public void notifyChildrenChanged(
      MediaSession.ControllerInfo browser, String parentId, int itemCount, @Nullable MediaLibraryService.LibraryParams params) {
    dispatchRemoteControllerTaskWithoutReturn(
        browser,
        (callback, seq) -> {
          if (!isSubscribed(callback, parentId)) {
  ...
  public void notifySearchResultChanged(
      MediaSession.ControllerInfo browser, String query, int itemCount, @Nullable MediaLibraryService.LibraryParams params) {
    dispatchRemoteControllerTaskWithoutReturn(
  ...
  public ListenableFuture<LibraryResult<MediaItem>> onGetLibraryRootOnHandler(
      MediaSession.ControllerInfo browser, @Nullable MediaLibraryService.LibraryParams params) {
    if (params != null
        && params.isRecent
      ...
      return getPlayerWrapper().getPlaybackState() == Player.STATE_IDLE
          ...
          : Futures.immediateFuture(
              LibraryResult.ofItemList(
                  ImmutableList.of(
                      new MediaItem.Builder()
                          .setMediaId("bidmachine.media3.session.recent.item")
                          .setMediaMetadata(
                              new MediaMetadata.Builder()
  ...
  public ListenableFuture<LibraryResult<Void>> onSubscribeOnHandler(
      MediaSession.ControllerInfo browser, String parentId, @Nullable MediaLibraryService.LibraryParams params) {
    MediaSession.ControllerCb controller = checkStateNotNull(browser.getControllerCb());
    synchronized (lock) {
  ...
  public ListenableFuture<LibraryResult<Void>> onUnsubscribeOnHandler(
      MediaSession.ControllerInfo browser, String parentId) {
    ListenableFuture<LibraryResult<Void>> future =
  ...
  public ListenableFuture<LibraryResult<Void>> onSearchOnHandler(
      MediaSession.ControllerInfo browser, String query, @Nullable MediaLibraryService.LibraryParams params) {
    ListenableFuture<LibraryResult<Void>> future =
  ...
  private boolean isSubscribed(MediaSession.ControllerCb callback, String parentId) {
    synchronized (lock) {
  ...
  private void maybeUpdateLegacyErrorState(LibraryResult<?> result) {
    ...
    if (result.resultCode == LibraryResult.RESULT_ERROR_SESSION_AUTHENTICATION_EXPIRED
        && result.params != null
        && result.params.extras.containsKey(
      ...
      if (playerWrapper.getLegacyStatusCode() != LibraryResult.RESULT_ERROR_SESSION_AUTHENTICATION_EXPIRED) {
        playerWrapper.setLegacyErrorStatus(
            MediaConstants.ERROR_CODE_AUTHENTICATION_EXPIRED_COMPAT,
    ...
    } else if (playerWrapper.getLegacyStatusCode() != LibraryResult.RESULT_SUCCESS) {
  ...
  private void removeSubscription(MediaSession.ControllerCb controllerCb, String parentId) {
    synchronized (lock) {
  ...
  private ListenableFuture<LibraryResult<ImmutableList<MediaItem>>>
      getRecentMediaItemAtDeviceBootTime(
          MediaSession.ControllerInfo controller, @Nullable MediaLibraryService.LibraryParams params) {
