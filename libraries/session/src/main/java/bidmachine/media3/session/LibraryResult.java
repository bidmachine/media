...
public final class LibraryResult<V> implements Bundleable {
   ...
   * {@link MediaLibraryService.LibraryParams params}.
   */
  public static LibraryResult<Void> ofVoid(@Nullable MediaLibraryService.LibraryParams params) {
    return new LibraryResult<>(
   ...
   */
  public static LibraryResult<MediaItem> ofItem(MediaItem item, @Nullable MediaLibraryService.LibraryParams params) {
  ...
  public static LibraryResult<ImmutableList<MediaItem>> ofItemList(
      List<MediaItem> items, @Nullable MediaLibraryService.LibraryParams params) {
  ...
  /**
   * Creates an instance with an unsuccessful {@link Code result code} and {@link MediaLibraryService.LibraryParams} to
   * describe the error.
   *
   * <p>{@code errorCode} must not be {@link #RESULT_SUCCESS}.
   *
   ...
   */
  public static <V> LibraryResult<V> ofError(@Code int errorCode, @Nullable MediaLibraryService.LibraryParams params) {
  ...
  private static LibraryResult<?> fromBundle(
    ...
    MediaLibraryService.LibraryParams params =
        paramsBundle == null ? null : MediaLibraryService.LibraryParams.CREATOR.fromBundle(paramsBundle);
