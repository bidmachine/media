...
import static bidmachine.media3.session.LibraryResult.RESULT_ERROR_PERMISSION_DENIED;
import static bidmachine.media3.session.LibraryResult.RESULT_ERROR_SESSION_DISCONNECTED;
import static bidmachine.media3.session.LibraryResult.RESULT_ERROR_UNKNOWN;
...
/* package */ class MediaBrowserImplLegacy extends MediaControllerImplLegacy
  ...
  private final HashMap<MediaLibraryService.LibraryParams, MediaBrowserCompat> browserCompats = new HashMap<>();
  ...
  private MediaBrowserCompat getBrowserCompat(MediaLibraryService.LibraryParams extras) {
    return browserCompats.get(extras);
  }

  private static Bundle createOptions(@Nullable MediaLibraryService.LibraryParams params) {
    return params == null ? new Bundle() : new Bundle(params.extras);
  }

  private static Bundle createOptions(@Nullable MediaLibraryService.LibraryParams params, int page, int pageSize) {
  ...
  private static Bundle getExtras(@Nullable MediaLibraryService.LibraryParams params) {
  ...
  private class GetLibraryRootCallback extends MediaBrowserCompat.ConnectionCallback {
    ...
    public GetLibraryRootCallback(
        SettableFuture<LibraryResult<MediaItem>> result, MediaLibraryService.LibraryParams params) {
      super();
      this.result = result;
      this.params = params;
    }
