...
import static bidmachine.media3.session.SessionToken.TYPE_BROWSER_SERVICE_LEGACY;
import static bidmachine.media3.session.SessionToken.TYPE_LIBRARY_SERVICE;
import static bidmachine.media3.session.SessionToken.TYPE_SESSION;
import static bidmachine.media3.session.SessionToken.TYPE_SESSION_LEGACY;
...
import bidmachine.media3.session.SessionToken.SessionTokenImpl;
