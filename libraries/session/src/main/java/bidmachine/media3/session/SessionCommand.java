...
public final class SessionCommand implements Bundleable {
  ...
  /** Command code for {@link MediaBrowser#getLibraryRoot(MediaLibraryService.LibraryParams)}. */
  public static final int COMMAND_CODE_LIBRARY_GET_LIBRARY_ROOT = 50000;

  /** Command code for {@link MediaBrowser#subscribe(String, MediaLibraryService.LibraryParams)}. */
  ...
  /** Command code for {@link MediaBrowser#getChildren(String, int, int, MediaLibraryService.LibraryParams)}. */
  ...
  /** Command code for {@link MediaBrowser#search(String, MediaLibraryService.LibraryParams)}. */
  public static final int COMMAND_CODE_LIBRARY_SEARCH = 50005;

  /** Command code for {@link MediaBrowser#getSearchResult(String, int, int, MediaLibraryService.LibraryParams)}. */
