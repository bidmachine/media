 ...
 */
package bidmachine.media3.extractor;

import static bidmachine.media3.common.FileTypes.inferFileTypeFromResponseHeaders;
import static bidmachine.media3.common.FileTypes.inferFileTypeFromUri;

import android.net.Uri;
import androidx.annotation.GuardedBy;
import androidx.annotation.Nullable;
import bidmachine.media3.common.FileTypes;
...
import bidmachine.media3.common.util.TimestampAdjuster;
import bidmachine.media3.common.util.UnstableApi;
import bidmachine.media3.extractor.amr.AmrExtractor;
import bidmachine.media3.extractor.avi.AviExtractor;
import bidmachine.media3.extractor.flac.FlacExtractor;
import bidmachine.media3.extractor.flv.FlvExtractor;
import bidmachine.media3.extractor.jpeg.JpegExtractor;
import bidmachine.media3.extractor.mkv.MatroskaExtractor;
import bidmachine.media3.extractor.mp3.Mp3Extractor;
import bidmachine.media3.extractor.mp4.FragmentedMp4Extractor;
import bidmachine.media3.extractor.mp4.Mp4Extractor;
import bidmachine.media3.extractor.ogg.OggExtractor;
import bidmachine.media3.extractor.ts.Ac3Extractor;
import bidmachine.media3.extractor.ts.Ac4Extractor;
import bidmachine.media3.extractor.ts.AdtsExtractor;
import bidmachine.media3.extractor.ts.DefaultTsPayloadReaderFactory;
import bidmachine.media3.extractor.ts.PsExtractor;
import bidmachine.media3.extractor.ts.TsExtractor;
import bidmachine.media3.extractor.ts.TsPayloadReader;
import bidmachine.media3.extractor.wav.WavExtractor;
 ...
 *   <li>FLAC
 *       <ul>
 *         <li>If available, the FLAC extension's {@code bidmachine.media3.decoder.flac.FlacExtractor}
 *             is used.
 ...
 *   <li>MIDI, if available, the MIDI extension's {@code bidmachine.media3.decoder.midi.MidiExtractor}
 *       is used.
 * </ul>
 */
@UnstableApi
public final class DefaultExtractorsFactory implements ExtractorsFactory {
   ...
   * by {@code bidmachine.media3.decoder.flac.FlacExtractor} instances if the FLAC extension is being
   * used.
   *
  ...
  private static Constructor<? extends Extractor> getMidiExtractorConstructor()
    ...
    return Class.forName("bidmachine.media3.decoder.midi.MidiExtractor")
  ...
  private static Constructor<? extends Extractor> getFlacExtractorConstructor()
    ...
    boolean isFlacNativeLibraryAvailable =
        Boolean.TRUE.equals(
            Class.forName("bidmachine.media3.decoder.flac.FlacLibrary")
                .getMethod("isAvailable")
                .invoke(/* obj= */ null));
    if (isFlacNativeLibraryAvailable) {
      return Class.forName("bidmachine.media3.decoder.flac.FlacExtractor")
          .asSubclass(Extractor.class)
