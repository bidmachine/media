...
import static bidmachine.media3.extractor.Ac4Util.AC40_SYNCWORD;
import static bidmachine.media3.extractor.Ac4Util.AC41_SYNCWORD;
import static bidmachine.media3.extractor.ts.TsPayloadReader.FLAG_DATA_ALIGNMENT_INDICATOR;
...
public final class Ac4Extractor implements Extractor {
  ...
  public boolean sniff(ExtractorInput input) throws IOException {
    ...
    ParsableByteArray scratch = new ParsableByteArray(Id3Decoder.ID3_HEADER_LENGTH);
    int startPosition = 0;
    while (true) {
