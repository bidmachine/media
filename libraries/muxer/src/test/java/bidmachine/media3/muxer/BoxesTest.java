 ...
 */
package bidmachine.media3.muxer;

import static bidmachine.media3.muxer.Mp4Muxer.LAST_FRAME_DURATION_BEHAVIOR_DUPLICATE_PREV_DURATION;
import static bidmachine.media3.muxer.Mp4Muxer.LAST_FRAME_DURATION_BEHAVIOR_INSERT_SHORT_FRAME;
...
import bidmachine.media3.test.utils.DumpableMp4Box;
...
public class BoxesTest {
  ...
  public void createTkhdBox_forVideoTrack_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(
        context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("video_track_tkhd_box"));
  }
  ...
  public void createTkhdBox_forAudioTrack_matchesExpected() throws IOException {
    ...
    DumpableMp4Box dumpableBox = new DumpableMp4Box(tkhdBox);
    DumpFileAsserts.assertOutput(
        context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("audio_track_tkhd_box"));
  }
  ...
  public void createMvhdBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("mvhd_box"));
  }
  ...
  public void createMdhdBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("mdhd_box"));
  }
  ...
  public void createVmhdBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("vmhd_box"));
  }
  ...
  public void createSmhdBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("smhd_box"));
  }
  ...
  public void createNmhdBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("nmhd_box"));
  }
  ...
  public void createEmptyDinfBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("dinf_box_empty"));
  }
  ...
  public void createHdlrBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("hdlr_box"));
  }
  ...
  public void createUdtaBox_matchesExpected() throws IOException {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("udta_box"));
  }
  ...
  public void createKeysBox_matchesExpected() throws Exception {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("keys_box"));
  }
  ...
  public void createIlstBox_matchesExpected() throws Exception {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("ilst_box"));
  }
  ...
  public void createUuidBox_forXmpData_matchesExpected() throws Exception {
    ...
    DumpFileAsserts.assertOutput(context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("uuid_box_XMP"));
  }
  ...
  public void createAudioSampleEntryBox_forMp4a_matchesExpected() throws Exception {
    ...
    DumpFileAsserts.assertOutput(
        context, dumpableBox, MuxerTestUtil.getExpectedDumpFilePath("audio_sample_entry_box_mp4a"));
  }
