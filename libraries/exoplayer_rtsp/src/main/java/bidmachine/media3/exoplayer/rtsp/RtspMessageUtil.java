...
/* package */ final class RtspMessageUtil {
  ...
  private static @RtspRequest.Method int parseMethodString(String method) {
    switch (method) {
      case "ANNOUNCE":
        return RtspRequest.METHOD_ANNOUNCE;
      case "DESCRIBE":
        return RtspRequest.METHOD_DESCRIBE;
      case "GET_PARAMETER":
        return RtspRequest.METHOD_GET_PARAMETER;
      case "OPTIONS":
        return RtspRequest.METHOD_OPTIONS;
      case "PAUSE":
        return RtspRequest.METHOD_PAUSE;
      case "PLAY":
        return RtspRequest.METHOD_PLAY;
      case "PLAY_NOTIFY":
        return RtspRequest.METHOD_PLAY_NOTIFY;
      case "RECORD":
        return RtspRequest.METHOD_RECORD;
      case "REDIRECT":
        return RtspRequest.METHOD_REDIRECT;
      case "SETUP":
        return RtspRequest.METHOD_SETUP;
      case "SET_PARAMETER":
        return RtspRequest.METHOD_SET_PARAMETER;
      case "TEARDOWN":
        return RtspRequest.METHOD_TEARDOWN;
      default:
