 ...
 */
package bidmachine.media3.exoplayer.rtsp;
...
import static bidmachine.media3.exoplayer.rtsp.RtspMessageChannel.DEFAULT_RTSP_PORT;
...
import bidmachine.media3.exoplayer.rtsp.RtspMessageChannel.InterleavedBinaryDataListener;
...
/* package */ final class RtspClient implements Closeable {
   ...
   *
   * <p>All selected tracks (represented by {@link RtspMediaPeriod.RtpLoadInfo}) must have valid transport.
   *
   * @param loadInfos A list of selected tracks represented by {@link RtspMediaPeriod.RtpLoadInfo}.
   */
  ...
  public void retryWithRtpTcp() {
    try {
      ...
      playbackEventListener.onPlaybackError(new RtspMediaSource.RtspPlaybackException(e));
    }
  }
  ...
  private void continueSetupRtspTrack() {
    @Nullable RtspMediaPeriod.RtpLoadInfo loadInfo = pendingSetupRtpLoadInfos.pollFirst();
    if (loadInfo == null) {
  ...
  private void dispatchRtspError(Throwable error) {
    RtspMediaSource.RtspPlaybackException playbackException =
        error instanceof RtspMediaSource.RtspPlaybackException
            ? (RtspMediaSource.RtspPlaybackException) error
            : new RtspMediaSource.RtspPlaybackException(error);
  ...
  private static boolean serverSupportsDescribe(List<Integer> serverSupportedMethods) {
    return serverSupportedMethods.isEmpty() || serverSupportedMethods.contains(
  ...
  private final class MessageSender {
    ...
    public void sendOptionsRequest(Uri uri, @Nullable String sessionId) {
      sendRequest(
          getRequestWithCommonHeaders(
              RtspRequest.METHOD_OPTIONS, sessionId, /* additionalHeaders= */ ImmutableMap.of(), uri));
    }

    public void sendDescribeRequest(Uri uri, @Nullable String sessionId) {
      sendRequest(
          getRequestWithCommonHeaders(
              RtspRequest.METHOD_DESCRIBE, sessionId, /* additionalHeaders= */ ImmutableMap.of(), uri));
    }
    ...
    public void sendTeardownRequest(Uri uri, String sessionId) {
      ...
      sendRequest(
          getRequestWithCommonHeaders(
              RtspRequest.METHOD_TEARDOWN, sessionId, /* additionalHeaders= */ ImmutableMap.of(), uri));
    }
    ...
    public void sendPauseRequest(Uri uri, String sessionId) {
      ...
      sendRequest(
          getRequestWithCommonHeaders(
              RtspRequest.METHOD_PAUSE, sessionId, /* additionalHeaders= */ ImmutableMap.of(), uri));
      ...
      try {
        switch (response.status) {
          ...
          case 401:
            ...
            dispatchRtspError(
                new RtspMediaSource.RtspPlaybackException(
          ...
          case 461:
            ...
            dispatchRtspError(
                requestMethod == RtspRequest.METHOD_SETUP && !transportHeaderValue.contains("TCP")
                    ? new RtspMediaSource.RtspUdpUnsupportedTransportException(exceptionMessage)
                    : new RtspMediaSource.RtspPlaybackException(exceptionMessage));
            return;
          default:
            dispatchRtspError(
                new RtspMediaSource.RtspPlaybackException(
        ...
        switch (requestMethod) {
          case RtspRequest.METHOD_OPTIONS:
          ...
          case RtspRequest.METHOD_DESCRIBE:
          ...
          case RtspRequest.METHOD_PAUSE:
            onPauseResponseReceived();
            break;

          case RtspRequest.METHOD_GET_PARAMETER:
          case RtspRequest.METHOD_TEARDOWN:
          case RtspRequest.METHOD_PLAY_NOTIFY:
          case RtspRequest.METHOD_RECORD:
          case RtspRequest.METHOD_REDIRECT:
          case RtspRequest.METHOD_ANNOUNCE:
          case RtspRequest.METHOD_SET_PARAMETER:
            break;
          case RtspRequest.METHOD_UNSET:
          default:
