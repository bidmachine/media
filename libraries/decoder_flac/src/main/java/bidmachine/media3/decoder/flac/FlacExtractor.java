 ...
 */
package bidmachine.media3.decoder.flac;

import static bidmachine.media3.common.util.Util.getPcmEncoding;
...
import bidmachine.media3.extractor.FlacMetadataReader;
import bidmachine.media3.extractor.FlacStreamMetadata;
...
public final class FlacExtractor implements Extractor {
  ...
  public static final int FLAG_DISABLE_ID3_METADATA =
      bidmachine.media3.extractor.flac.FlacExtractor.FLAG_DISABLE_ID3_METADATA;
  ...
  private @MonotonicNonNull FlacBinarySearchSeeker.OutputFrameHolder outputFrameHolder;
