...
import static bidmachine.media3.test.session.common.TestUtils.getCommandsAsList;
...
import bidmachine.media3.session.PlayerInfo;
...
public final class MediaUtilsTest {
  ...
  public void convertToMediaDescriptionCompat_setsExpectedValues() {
    ...
    assertThat(
            descriptionCompat
                .getExtras()
                .getLong(bidmachine.media3.session.MediaConstants.EXTRAS_KEY_MEDIA_TYPE_COMPAT))
  ...
  public void convertToMediaMetadataCompat_withMediaType_setsMediaType() {
    ...
    assertThat(
            mediaMetadataCompat.getLong(
                bidmachine.media3.session.MediaConstants.EXTRAS_KEY_MEDIA_TYPE_COMPAT))
        .isEqualTo(MediaMetadata.MEDIA_TYPE_MUSIC);
  }
