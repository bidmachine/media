...
import static bidmachine.media3.test.session.common.CommonConstants.ACTION_MEDIA_SESSION_COMPAT;
import static bidmachine.media3.test.session.common.CommonConstants.KEY_METADATA_COMPAT;
import static bidmachine.media3.test.session.common.CommonConstants.KEY_PLAYBACK_STATE_COMPAT;
import static bidmachine.media3.test.session.common.CommonConstants.KEY_QUEUE;
import static bidmachine.media3.test.session.common.CommonConstants.KEY_SESSION_COMPAT_TOKEN;
import static bidmachine.media3.test.session.common.CommonConstants.MEDIA_SESSION_COMPAT_PROVIDER_SERVICE;
...
import bidmachine.media3.test.session.common.IRemoteMediaSessionCompat;
