...
import static bidmachine.media3.session.MediaConstants.EXTRAS_KEY_COMPLETION_STATUS;
import static bidmachine.media3.session.MediaConstants.EXTRAS_KEY_ERROR_RESOLUTION_ACTION_INTENT_COMPAT;
import static bidmachine.media3.session.MediaConstants.EXTRAS_KEY_ERROR_RESOLUTION_ACTION_LABEL_COMPAT;
import static bidmachine.media3.session.MediaConstants.EXTRAS_VALUE_COMPLETION_STATUS_PARTIALLY_PLAYED;
import static bidmachine.media3.session.MediaConstants.EXTRA_KEY_ROOT_CHILDREN_BROWSABLE_ONLY;
import static bidmachine.media3.session.MediaTestUtils.assertLibraryParamsEquals;
import static bidmachine.media3.test.session.common.CommonConstants.SUPPORT_APP_PACKAGE_NAME;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.CUSTOM_ACTION;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.CUSTOM_ACTION_ASSERT_PARAMS;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.CUSTOM_ACTION_EXTRAS;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.GET_CHILDREN_RESULT;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.LONG_LIST_COUNT;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.MEDIA_ID_GET_BROWSABLE_ITEM;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.MEDIA_ID_GET_ITEM_WITH_METADATA;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.MEDIA_ID_GET_PLAYABLE_ITEM;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.NOTIFY_CHILDREN_CHANGED_EXTRAS;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.NOTIFY_CHILDREN_CHANGED_ITEM_COUNT;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.PARENT_ID;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.PARENT_ID_AUTH_EXPIRED_ERROR;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.PARENT_ID_AUTH_EXPIRED_ERROR_KEY_ERROR_RESOLUTION_ACTION_LABEL;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.PARENT_ID_ERROR;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.PARENT_ID_LONG_LIST;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.ROOT_EXTRAS;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.ROOT_ID;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.ROOT_ID_SUPPORTS_BROWSABLE_CHILDREN_ONLY;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SEARCH_QUERY;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SEARCH_QUERY_EMPTY_RESULT;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SEARCH_QUERY_LONG_LIST;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SEARCH_QUERY_TAKES_TIME;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SEARCH_RESULT;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SEARCH_RESULT_COUNT;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SEARCH_TIME_IN_MS;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SUBSCRIBE_ID_NOTIFY_CHILDREN_CHANGED_TO_ALL;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SUBSCRIBE_ID_NOTIFY_CHILDREN_CHANGED_TO_ALL_WITH_NON_SUBSCRIBED_ID;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SUBSCRIBE_ID_NOTIFY_CHILDREN_CHANGED_TO_ONE;
import static bidmachine.media3.test.session.common.MediaBrowserConstants.SUBSCRIBE_ID_NOTIFY_CHILDREN_CHANGED_TO_ONE_WITH_NON_SUBSCRIBED_ID;
...
import bidmachine.media3.test.session.common.CommonConstants;
