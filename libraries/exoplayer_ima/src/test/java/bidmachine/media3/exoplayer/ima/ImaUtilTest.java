...
import static bidmachine.media3.common.AdPlaybackState.AD_STATE_ERROR;
import static bidmachine.media3.common.AdPlaybackState.AD_STATE_PLAYED;
import static bidmachine.media3.common.AdPlaybackState.AD_STATE_SKIPPED;
...
import static bidmachine.media3.exoplayer.ima.ImaUtil.addLiveAdBreak;
import static bidmachine.media3.exoplayer.ima.ImaUtil.getAdGroupAndIndexInLiveMultiPeriodTimeline;
import static bidmachine.media3.exoplayer.ima.ImaUtil.getAdGroupAndIndexInVodMultiPeriodTimeline;
import static bidmachine.media3.exoplayer.ima.ImaUtil.handleAdPeriodRemovedFromTimeline;
import static bidmachine.media3.exoplayer.ima.ImaUtil.maybeCorrectPreviouslyUnknownAdDurations;
import static bidmachine.media3.exoplayer.ima.ImaUtil.secToUsRounded;
import static bidmachine.media3.exoplayer.ima.ImaUtil.splitAdGroup;
import static bidmachine.media3.exoplayer.source.ads.ServerSideAdInsertionUtil.addAdGroupToAdPlaybackState;
import static bidmachine.media3.test.utils.FakeMultiPeriodLiveTimeline.AD_PERIOD_DURATION_MS;
import static bidmachine.media3.test.utils.FakeMultiPeriodLiveTimeline.PERIOD_DURATION_MS;
...
import bidmachine.media3.exoplayer.ima.ImaUtil;
import bidmachine.media3.test.utils.FakeMultiPeriodLiveTimeline;
