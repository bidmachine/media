...
public final class DefaultMediaItemConverter implements MediaItemConverter {
  ...
  public MediaItem toMediaItem(MediaQueueItem mediaQueueItem) {
    ...
    bidmachine.media3.common.MediaMetadata.Builder metadataBuilder =
        new bidmachine.media3.common.MediaMetadata.Builder();
  ...
  private static MediaItem getMediaItem(
      JSONObject customData, bidmachine.media3.common.MediaMetadata mediaMetadata) {
    try {
