...
import static bidmachine.media3.common.util.Util.binarySearchCeil;
import static bidmachine.media3.common.util.Util.binarySearchFloor;
import static bidmachine.media3.common.util.Util.escapeFileName;
import static bidmachine.media3.common.util.Util.getCodecsOfType;
import static bidmachine.media3.common.util.Util.getStringForTime;
import static bidmachine.media3.common.util.Util.gzip;
import static bidmachine.media3.common.util.Util.maxValue;
import static bidmachine.media3.common.util.Util.minValue;
import static bidmachine.media3.common.util.Util.parseXsDateTime;
import static bidmachine.media3.common.util.Util.parseXsDuration;
import static bidmachine.media3.common.util.Util.unescapeFileName;
