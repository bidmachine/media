...
public interface GlObjectsProvider {
   ...
   * @throws GlUtil.GlException If an error occurs during creation.
   */
  @RequiresApi(17)
  ...
  EGLSurface createFocusedPlaceholderEglSurface(
      EGLContext eglContext, EGLDisplay eglDisplay, int[] configAttributes) throws GlUtil.GlException;
