...
public abstract class Action {
   ...
   * HandlerWrapper, ActionSchedule.ActionNode)} to perform the action.
   *
  ...
  /* package */ final void doActionAndScheduleNext(
      ...
      @Nullable ActionSchedule.ActionNode nextAction) {
    if (description != null) {
   ...
   * HandlerWrapper, ActionSchedule.ActionNode)} to perform the action and to schedule the next action node.
   *
   * @param player The player to which the action should be applied.
   * @param trackSelector The track selector to which the action should be applied.
   * @param surface The surface to use when applying actions, or {@code null} if no surface is
  ...
  public static final class SendMessages extends Action {
    ...
    protected void doActionImpl(
      ...
      if (target instanceof ActionSchedule.PlayerTarget) {
        ((ActionSchedule.PlayerTarget) target).setPlayer(player);
      }
  ...
  public static final class WaitForTimelineChanged extends Action {
    ...
    /* package */ void doActionAndScheduleNextImpl(
      ...
      Player.Listener listener =
          new Player.Listener() {
            ...
            public void onTimelineChanged(
              ...
              if ((expectedTimeline == null || TestUtil.timelinesAreSame(timeline, expectedTimeline))
      ...
      if (expectedTimeline != null
          && TestUtil.timelinesAreSame(player.getCurrentTimeline(), expectedTimeline)) {
  ...
  public static final class WaitForMessage extends Action {
     ...
     */
    public WaitForMessage(@Size(max = 23) String tag, ActionSchedule.PlayerTarget playerTarget) {
    ...
    /* package */ void doActionAndScheduleNextImpl(
      ...
      ActionSchedule.PlayerTarget.Callback callback =
          () -> nextAction.schedule(player, trackSelector, surface, handler);
  ...
  public static final class ExecuteRunnable extends Action {
    ...
    protected void doActionImpl(
      ...
      if (runnable instanceof ActionSchedule.PlayerRunnable) {
        ((ActionSchedule.PlayerRunnable) runnable).setPlayer(player);
      }
      runnable.run();
    }
  }
