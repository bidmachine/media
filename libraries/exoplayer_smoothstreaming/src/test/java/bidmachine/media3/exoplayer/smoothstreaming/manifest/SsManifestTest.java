...
import bidmachine.media3.exoplayer.smoothstreaming.SsTestUtils;
...
public class SsManifestTest {
  ...
  public void copyRemoveStreamElement() throws Exception {
    ...
    SsManifest expectedManifest = SsTestUtils.createSsManifest(createStreamElement("2", formats[1][0]));
    assertManifestEquals(expectedManifest, copyManifest);
  }
