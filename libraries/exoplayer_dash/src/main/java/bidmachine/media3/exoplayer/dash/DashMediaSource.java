 ...
 */
package bidmachine.media3.exoplayer.dash;
...
import static bidmachine.media3.common.util.Util.usToMs;
...
import bidmachine.media3.common.ParserException;
...
import bidmachine.media3.datasource.DataSource;
import bidmachine.media3.datasource.TransferListener;
import bidmachine.media3.exoplayer.dash.PlayerEmsgHandler.PlayerEmsgCallback;
import bidmachine.media3.exoplayer.dash.manifest.AdaptationSet;
import bidmachine.media3.exoplayer.dash.manifest.DashManifest;
import bidmachine.media3.exoplayer.dash.manifest.DashManifestParser;
import bidmachine.media3.exoplayer.dash.manifest.Period;
import bidmachine.media3.exoplayer.dash.manifest.Representation;
import bidmachine.media3.exoplayer.dash.manifest.UtcTimingElement;
import bidmachine.media3.exoplayer.drm.DefaultDrmSessionManagerProvider;
import bidmachine.media3.exoplayer.drm.DrmSessionEventListener;
import bidmachine.media3.exoplayer.drm.DrmSessionManager;
import bidmachine.media3.exoplayer.drm.DrmSessionManagerProvider;
import bidmachine.media3.exoplayer.offline.FilteringManifestParser;
import bidmachine.media3.exoplayer.source.BaseMediaSource;
import bidmachine.media3.exoplayer.source.BehindLiveWindowException;
import bidmachine.media3.exoplayer.source.CompositeSequenceableLoaderFactory;
import bidmachine.media3.exoplayer.source.DefaultCompositeSequenceableLoaderFactory;
...
import bidmachine.media3.exoplayer.source.MediaSourceEventListener.EventDispatcher;
import bidmachine.media3.exoplayer.source.MediaSourceFactory;
import bidmachine.media3.exoplayer.source.SequenceableLoader;
import bidmachine.media3.exoplayer.upstream.Allocator;
import bidmachine.media3.exoplayer.upstream.CmcdConfiguration;
import bidmachine.media3.exoplayer.upstream.DefaultLoadErrorHandlingPolicy;
import bidmachine.media3.exoplayer.upstream.LoadErrorHandlingPolicy;
import bidmachine.media3.exoplayer.upstream.LoadErrorHandlingPolicy.LoadErrorInfo;
import bidmachine.media3.exoplayer.upstream.Loader;
import bidmachine.media3.exoplayer.upstream.Loader.LoadErrorAction;
import bidmachine.media3.exoplayer.upstream.LoaderErrorThrower;
import bidmachine.media3.exoplayer.upstream.ParsingLoadable;
import bidmachine.media3.exoplayer.util.SntpClient;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  public static final class Factory implements MediaSourceFactory {
     ...
     * BehindLiveWindowException} issues.
     *
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      bidmachine.media3.exoplayer.dash.manifest.Period period = manifest.getPeriod(periodIndex);
