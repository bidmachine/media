 ...
 */
package bidmachine.media3.exoplayer.dash.manifest;
...
import bidmachine.media3.common.util.XmlPullParserUtil;
...
public class DashManifestParser extends DefaultHandler
  ...
  protected DashManifest parseMediaPresentationDescription(XmlPullParser xpp, Uri documentBaseUri)
    ...
    BaseUrl documentBaseUrl =
        new BaseUrl(
            ...
            dvbProfileDeclared ? BaseUrl.DEFAULT_DVB_PRIORITY : BaseUrl.PRIORITY_UNSET,
            BaseUrl.DEFAULT_WEIGHT);
  ...
  protected SegmentBase.SingleSegmentBase parseSegmentBase(
      XmlPullParser xpp, @Nullable SegmentBase.SingleSegmentBase parent)
      throws XmlPullParserException, IOException {
  ...
  protected SegmentBase.SegmentList buildSegmentList(
      ...
      long timeShiftBufferDepthMs,
      long periodStartUnixTimeMs) {
    return new SegmentBase.SegmentList(
        initialization,
        timescale,
        presentationTimeOffset,
        startNumber,
  ...
  protected List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(
