...
import static bidmachine.media3.common.MimeTypes.VIDEO_H265;
...
import bidmachine.media3.transformer.EncoderUtil;
...
public final class HdrEditingTest {
  ...
  public void export_transmuxHdr10File() throws Exception {
    ...
    if (Util.SDK_INT < 24) {
      ...
      AndroidTestUtil.recordTestSkipped(context, testId, /* reason= */ "Can't transmux H.265/HEVC before API 24");
      return;
    }
    ...
    if (AndroidTestUtil.skipAndLogIfFormatsUnsupported(
        context,
        testId,
        /* inputFormat= */ AndroidTestUtil.MP4_ASSET_720P_4_SECOND_HDR10_FORMAT,
        /* outputFormat= */ null)) {
      return;
    }

    Transformer transformer = new Transformer.Builder(context).build();
    MediaItem mediaItem = MediaItem.fromUri(Uri.parse(AndroidTestUtil.MP4_ASSET_720P_4_SECOND_HDR10));

    ExportTestResult exportTestResult =
        new TransformerAndroidTestRunner.Builder(context, transformer)
            .build()
            .run(testId, mediaItem);
    FileUtil.assertFileHasColorTransfer(context, exportTestResult.filePath, C.COLOR_TRANSFER_ST2084);
  }
  ...
  public void export_transmuxHlg10File() throws Exception {
    ...
    if (AndroidTestUtil.skipAndLogIfFormatsUnsupported(
        context,
        testId,
        /* inputFormat= */ AndroidTestUtil.MP4_ASSET_1080P_5_SECOND_HLG10_FORMAT,
        /* outputFormat= */ null)) {
      return;
    }

    Transformer transformer = new Transformer.Builder(context).build();
    MediaItem mediaItem = MediaItem.fromUri(Uri.parse(AndroidTestUtil.MP4_ASSET_1080P_5_SECOND_HLG10));

    ExportTestResult exportTestResult =
        new TransformerAndroidTestRunner.Builder(context, transformer)
            .build()
            .run(testId, mediaItem);
    FileUtil.assertFileHasColorTransfer(context, exportTestResult.filePath, C.COLOR_TRANSFER_HLG);
  }
  ...
  public void exportAndTranscode_hdr10File_whenHdrEditingIsSupported() throws Exception {
    ...
    if (!deviceSupportsHdrEditing(VIDEO_H265, HDR10_DEFAULT_COLOR_INFO)) {
      AndroidTestUtil.recordTestSkipped(context, testId, /* reason= */ "Device lacks HDR10 editing support.");
      return;
    }
    ...
    if (AndroidTestUtil.skipAndLogIfFormatsUnsupported(
        ...
        testId,
        /* inputFormat= */ AndroidTestUtil.MP4_ASSET_720P_4_SECOND_HDR10_FORMAT,
        /* outputFormat= */ AndroidTestUtil.MP4_ASSET_720P_4_SECOND_HDR10_FORMAT)) {
      return;
    }
    ...
    EditedMediaItem editedMediaItem =
        new EditedMediaItem.Builder(mediaItem).setEffects(
            AndroidTestUtil.FORCE_TRANSCODE_VIDEO_EFFECTS).build();
  ...
  public void exportAndTranscode_hlg10File_whenHdrEditingIsSupported() throws Exception {
    ...
    if (!deviceSupportsHdrEditing(VIDEO_H265, HLG10_DEFAULT_COLOR_INFO)) {
      AndroidTestUtil.recordTestSkipped(context, testId, /* reason= */ "Device lacks HLG10 editing support.");
      return;
    }
    ...
    if (AndroidTestUtil.skipAndLogIfFormatsUnsupported(
        ...
        testId,
        /* inputFormat= */ AndroidTestUtil.MP4_ASSET_1080P_5_SECOND_HLG10_FORMAT,
        /* outputFormat= */ AndroidTestUtil.MP4_ASSET_1080P_5_SECOND_HLG10_FORMAT)) {
      return;
    }
  ...
  public void exportAndTranscode_dolbyVisionFile_whenHdrEditingIsSupported() throws Exception {
    ...
    if (AndroidTestUtil.skipAndLogIfFormatsUnsupported(
        context,
        testId,
        /* inputFormat= */ AndroidTestUtil.MP4_ASSET_DOLBY_VISION_HDR_FORMAT,
        /* outputFormat= */ AndroidTestUtil.MP4_ASSET_DOLBY_VISION_HDR_FORMAT)) {
      return;
    }

    Transformer transformer = new Transformer.Builder(context).build();
    MediaItem mediaItem = MediaItem.fromUri(Uri.parse(AndroidTestUtil.MP4_ASSET_DOLBY_VISION_HDR));
    EditedMediaItem editedMediaItem =
        new EditedMediaItem.Builder(mediaItem).setEffects(
            AndroidTestUtil.FORCE_TRANSCODE_VIDEO_EFFECTS).build();
  ...
  public void exportAndTranscode_hdr10File_whenHdrEditingUnsupported_toneMapsOrThrows()
    ...
    Context context = ApplicationProvider.getApplicationContext();
    if (deviceSupportsHdrEditing(VIDEO_H265, HDR10_DEFAULT_COLOR_INFO)) {
      AndroidTestUtil.recordTestSkipped(context, testId, /* reason= */ "Device supports HDR10 editing.");
      return;
    }
    ...
    try {
      ...
      FileUtil.assertFileHasColorTransfer(context, exportTestResult.filePath, C.COLOR_TRANSFER_SDR);
  ...
  public void exportAndTranscode_hlg10File_whenHdrEditingUnsupported_toneMapsOrThrows()
    ...
    Context context = ApplicationProvider.getApplicationContext();
    if (deviceSupportsHdrEditing(VIDEO_H265, HLG10_DEFAULT_COLOR_INFO)) {
      AndroidTestUtil.recordTestSkipped(context, testId, /* reason= */ "Device supports HLG10 editing.");
      return;
    }
