...
import static bidmachine.media3.test.utils.BitmapPixelTestUtil.MAXIMUM_AVERAGE_PIXEL_ABSOLUTE_DIFFERENCE_DIFFERENT_DEVICE;
import static bidmachine.media3.test.utils.BitmapPixelTestUtil.MAXIMUM_AVERAGE_PIXEL_ABSOLUTE_DIFFERENCE_DIFFERENT_DEVICE_FP16;
import static bidmachine.media3.test.utils.BitmapPixelTestUtil.getBitmapAveragePixelAbsoluteDifferenceArgb8888;
import static bidmachine.media3.test.utils.BitmapPixelTestUtil.readBitmap;
import static bidmachine.media3.test.utils.VideoFrameProcessorTestRunner.VIDEO_FRAME_PROCESSING_WAIT_MS;
...
import static bidmachine.media3.transformer.AndroidTestUtil.MP4_ASSET_FORMAT;
...
import bidmachine.media3.common.GlObjectsProvider;
import bidmachine.media3.common.GlTextureInfo;
...
import bidmachine.media3.effect.DefaultGlObjectsProvider;
import bidmachine.media3.effect.DefaultVideoFrameProcessor;
import bidmachine.media3.effect.OverlayEffect;
import bidmachine.media3.test.utils.BitmapPixelTestUtil;
import bidmachine.media3.test.utils.VideoFrameProcessorTestRunner;
  ...
  public void noOpEffect_hlg10Input_matchesGoldenFile() throws Exception {
    ...
    videoFrameProcessorTestRunner =
        getSurfaceInputFrameProcessorTestRunnerBuilder(testId)
            ...
            .setOutputColorInfo(colorInfo)
            .setVideoAssetPath(INPUT_HLG10_MP4_ASSET_STRING)
            .setEffects(UnoptimizedGlEffect.NO_OP_EFFECT)
            .build();
    Bitmap expectedBitmap = readBitmap(ORIGINAL_HLG10_PNG_ASSET_PATH);
  ...
  public void noOpEffect_hlg10TextureInput_matchesGoldenFile() throws Exception {
    ...
    VideoFrameProcessorTestRunner texIdProducingVideoFrameProcessorTestRunner =
        getTexIdProducingFrameProcessorTestRunner(
            ...
            INPUT_HLG10_MP4_ASSET_STRING,
            colorInfo,
            ImmutableList.of(UnoptimizedGlEffect.NO_OP_EFFECT));
    Bitmap expectedBitmap = readBitmap(ORIGINAL_HLG10_PNG_ASSET_PATH);
