  ...
  public JSONObject asJsonObject() throws JSONException {
    JSONObject jsonObject =
        new JSONObject()
            ...
            .putOpt("testException", AndroidTestUtil.exceptionAsJsonObject(exportResult.exportException))
            .putOpt("analysisException", AndroidTestUtil.exceptionAsJsonObject(analysisException));

    if (!exportResult.processedInputs.isEmpty()) {
      jsonObject.put("processedInputs", AndroidTestUtil.processedInputsAsJsonArray(exportResult.processedInputs));
    }
