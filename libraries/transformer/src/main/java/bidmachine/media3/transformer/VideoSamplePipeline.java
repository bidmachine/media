...
import static bidmachine.media3.common.ColorInfo.SDR_BT709_LIMITED;
import static bidmachine.media3.common.ColorInfo.SRGB_BT709_FULL;
import static bidmachine.media3.common.ColorInfo.isTransferHdr;
import static bidmachine.media3.common.VideoFrameProcessor.INPUT_TYPE_BITMAP;
import static bidmachine.media3.common.VideoFrameProcessor.INPUT_TYPE_SURFACE;
import static bidmachine.media3.common.VideoFrameProcessor.INPUT_TYPE_TEXTURE_ID;
...
import static bidmachine.media3.transformer.EncoderUtil.getSupportedEncodersForHdrEditing;
...
import bidmachine.media3.common.FrameInfo;
import bidmachine.media3.common.MimeTypes;
import bidmachine.media3.common.OnInputFrameProcessedListener;
import bidmachine.media3.common.SurfaceInfo;
import bidmachine.media3.common.VideoFrameProcessingException;
import bidmachine.media3.common.VideoFrameProcessor;
...
import bidmachine.media3.effect.DebugTraceUtil;
import bidmachine.media3.effect.Presentation;
import bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil;
...
/* package */ final class VideoSamplePipeline extends SamplePipeline {
  ...
  public VideoSamplePipeline(
    ...
    boolean isMediaCodecToneMapping =
        encoderWrapper.getHdrModeAfterFallback() == TransformationRequest.HDR_MODE_TONE_MAP_HDR_TO_SDR_USING_MEDIACODEC
    ...
    boolean isGlToneMapping =
        ColorInfo.isTransferHdr(decoderInputColor)
            && transformationRequest.hdrMode == TransformationRequest.HDR_MODE_TONE_MAP_HDR_TO_SDR_USING_OPEN_GL;
  ...
  /* package */ static final class EncoderWrapper {
    ...
    private static Pair<String, Integer> getRequestedOutputMimeTypeAndHdrModeAfterFallback(
      ...
      if (hdrMode == TransformationRequest.HDR_MODE_KEEP_HDR && isTransferHdr(inputFormat.colorInfo)) {
        ...
        if (hdrEncoders.isEmpty()) {
          hdrMode = TransformationRequest.HDR_MODE_TONE_MAP_HDR_TO_SDR_USING_MEDIACODEC;
        }
      }
    ...
    private ColorInfo getSupportedInputColor() {
      boolean isInputToneMapped =
          isTransferHdr(inputFormat.colorInfo) && hdrModeAfterFallback != TransformationRequest.HDR_MODE_KEEP_HDR;
