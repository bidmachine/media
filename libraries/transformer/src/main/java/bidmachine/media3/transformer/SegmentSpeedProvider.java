...
import static bidmachine.media3.extractor.metadata.mp4.SlowMotionData.Segment.BY_START_THEN_END_THEN_DIVISOR;
...
import bidmachine.media3.extractor.metadata.mp4.SlowMotionData.Segment;
