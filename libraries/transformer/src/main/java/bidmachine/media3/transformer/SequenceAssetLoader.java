...
/* package */ final class SequenceAssetLoader implements AssetLoader, AssetLoader.Listener {
  ...
  public @Transformer.ProgressState int getProgress(ProgressHolder progressHolder) {
    ...
    if (mediaItemCount == 1 || progressState == Transformer.PROGRESS_STATE_NOT_STARTED) {
  ...
  public boolean onTrackAdded(Format inputFormat, @SupportedOutputTypes int supportedOutputTypes) {
    boolean isAudio = TransformerUtil.getProcessedTrackType(inputFormat.sampleMimeType) == C.TRACK_TYPE_AUDIO;
  ...
  public SampleConsumer onOutputFormat(Format format) throws ExportException {
    @C.TrackType int trackType = TransformerUtil.getProcessedTrackType(format.sampleMimeType);
