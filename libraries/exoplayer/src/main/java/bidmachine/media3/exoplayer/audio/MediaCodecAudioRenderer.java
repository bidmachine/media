...
import bidmachine.media3.exoplayer.MediaClock;
import bidmachine.media3.exoplayer.RendererCapabilities;
import bidmachine.media3.exoplayer.audio.AudioSink.InitializationException;
import bidmachine.media3.exoplayer.audio.AudioSink.WriteException;
...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
  ...
  protected @RendererCapabilities.Capabilities int supportsFormat(MediaCodecSelector mediaCodecSelector, Format format)
    ...
    int tunnelingSupport = Util.SDK_INT >= 21 ? RendererCapabilities.TUNNELING_SUPPORTED : RendererCapabilities.TUNNELING_NOT_SUPPORTED;
    ...
    if (supportsFormatDrm
      ...
      return RendererCapabilities.create(C.FORMAT_HANDLED, RendererCapabilities.ADAPTIVE_NOT_SEAMLESS, tunnelingSupport);
    }
  ...
  public void handleMessage(@Renderer.MessageType int messageType, @Nullable Object message)
    ...
    switch (messageType) {
      ...
      case Renderer.MSG_SET_AUX_EFFECT_INFO:
        ...
        break;
      case Renderer.MSG_SET_PREFERRED_AUDIO_DEVICE:
        if (Util.SDK_INT >= 23) {
