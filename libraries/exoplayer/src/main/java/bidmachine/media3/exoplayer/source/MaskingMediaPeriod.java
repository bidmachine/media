...
/**
 * Media period that defers calling {@link MediaSource#createPeriod(MediaSource.MediaPeriodId, Allocator, long)}
 * on a given source until {@link #createPeriod(MediaSource.MediaPeriodId)} has been called. This is useful if
...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
   ...
   * be called before {@link #createPeriod(MediaSource.MediaPeriodId)}.
   *
