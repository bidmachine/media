...
import static bidmachine.media3.common.C.TRACK_TYPE_AUDIO;
import static bidmachine.media3.common.C.TRACK_TYPE_CAMERA_MOTION;
import static bidmachine.media3.common.C.TRACK_TYPE_VIDEO;
...
import static bidmachine.media3.common.util.Util.castNonNull;
...
import bidmachine.media3.common.AuxEffectInfo;
import bidmachine.media3.common.BasePlayer;
...
import bidmachine.media3.common.IllegalSeekPositionException;
...
import bidmachine.media3.common.PriorityTaskManager;
...
import bidmachine.media3.common.util.Size;
import bidmachine.media3.common.util.Util;
import bidmachine.media3.exoplayer.analytics.AnalyticsCollector;
import bidmachine.media3.exoplayer.analytics.AnalyticsListener;
import bidmachine.media3.exoplayer.analytics.DefaultAnalyticsCollector;
import bidmachine.media3.exoplayer.analytics.MediaMetricsListener;
import bidmachine.media3.exoplayer.analytics.PlayerId;
...
import bidmachine.media3.exoplayer.trackselection.ExoTrackSelection;
import bidmachine.media3.exoplayer.trackselection.TrackSelectionArray;
import bidmachine.media3.exoplayer.trackselection.TrackSelector;
import bidmachine.media3.exoplayer.trackselection.TrackSelectorResult;
import bidmachine.media3.exoplayer.upstream.BandwidthMeter;
import bidmachine.media3.exoplayer.video.VideoDecoderOutputBufferRenderer;
import bidmachine.media3.exoplayer.video.VideoFrameMetadataListener;
import bidmachine.media3.exoplayer.video.VideoRendererEventListener;
import bidmachine.media3.exoplayer.video.spherical.CameraMotionListener;
import bidmachine.media3.exoplayer.video.spherical.SphericalGLSurfaceView;
...
/* package */ final class ExoPlayerImpl extends BasePlayer
  ...
  public ExoPlayerImpl(ExoPlayer.Builder builder, @Nullable Player wrappingPlayer) {
    ...
    try {
      ...
      sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_AUDIO_SESSION_ID, audioSessionId);
      sendRendererMessage(TRACK_TYPE_VIDEO, Renderer.MSG_SET_AUDIO_SESSION_ID, audioSessionId);
      sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_AUDIO_ATTRIBUTES, audioAttributes);
      sendRendererMessage(TRACK_TYPE_VIDEO, Renderer.MSG_SET_SCALING_MODE, videoScalingMode);
      sendRendererMessage(
          TRACK_TYPE_VIDEO, Renderer.MSG_SET_CHANGE_FRAME_RATE_STRATEGY, videoChangeFrameRateStrategy);
      sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_SKIP_SILENCE_ENABLED, skipSilenceEnabled);
      sendRendererMessage(
          TRACK_TYPE_VIDEO, Renderer.MSG_SET_VIDEO_FRAME_METADATA_LISTENER, frameMetadataListener);
      sendRendererMessage(
          TRACK_TYPE_CAMERA_MOTION, Renderer.MSG_SET_CAMERA_MOTION_LISTENER, frameMetadataListener);
    } finally {
  ...
  public void setVideoEffects(List<Effect> videoEffects) {
    verifyApplicationThread();
    sendRendererMessage(TRACK_TYPE_VIDEO, Renderer.MSG_SET_VIDEO_EFFECTS, videoEffects);
  }
  ...
  public void setAudioAttributes(AudioAttributes newAudioAttributes, boolean handleAudioFocus) {
    ...
    if (!Util.areEqual(this.audioAttributes, newAudioAttributes)) {
      ...
      sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_AUDIO_ATTRIBUTES, newAudioAttributes);
      if (streamVolumeManager != null) {
  ...
  public void setAuxEffectInfo(AuxEffectInfo auxEffectInfo) {
    verifyApplicationThread();
    sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_AUX_EFFECT_INFO, auxEffectInfo);
  }
  ...
  public void setPreferredAudioDevice(@Nullable AudioDeviceInfo audioDeviceInfo) {
    verifyApplicationThread();
    sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_PREFERRED_AUDIO_DEVICE, audioDeviceInfo);
  }
  ...
  public void setSkipSilenceEnabled(boolean newSkipSilenceEnabled) {
    ...
    sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_SKIP_SILENCE_ENABLED, newSkipSilenceEnabled);
    listeners.sendEvent(
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceSize.getWidth() || height != surfaceSize.getHeight()) {
      ...
      sendRendererMessage(
          TRACK_TYPE_VIDEO, Renderer.MSG_SET_VIDEO_OUTPUT_RESOLUTION, new Size(width, height));
    }
  }

  private void sendVolumeToRenderers() {
    float scaledVolume = volume * audioFocusManager.getVolumeMultiplier();
    sendRendererMessage(TRACK_TYPE_AUDIO, Renderer.MSG_SET_VOLUME, scaledVolume);
  }
