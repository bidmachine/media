...
public final class OfflineLicenseHelper {
   ...
   * @throws DrmSession.DrmSessionException Thrown when a DRM session error occurs.
   */
  ...
  private byte[] acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(
      @DefaultDrmSessionManager.Mode int licenseMode, @Nullable byte[] offlineLicenseKeySetId, Format format)
      throws DrmSession.DrmSessionException {
    DrmSession drmSession =
  ...
  private DrmSession acquireFirstSessionOnHandlerThread(
    ...
    SettableFuture<DrmSession.@NullableType DrmSessionException> drmSessionError = SettableFuture.create();
    handler.post(
        () -> {
          try {
