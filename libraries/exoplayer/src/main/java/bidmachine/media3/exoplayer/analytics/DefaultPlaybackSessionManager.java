...
public final class DefaultPlaybackSessionManager implements PlaybackSessionManager {
  ...
  private final class SessionDescriptor {
    ...
    private MediaSource.@MonotonicNonNull MediaPeriodId adMediaPeriodId;

    private boolean isCreated;
    private boolean isActive;

    public SessionDescriptor(
        String sessionId, int windowIndex, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
    ...
    public boolean belongsToSession(
        int eventWindowIndex, @Nullable MediaSource.MediaPeriodId eventMediaPeriodId) {
