 ...
 */
package bidmachine.media3.exoplayer.mediacodec;
...
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_DRM_SESSION_CHANGED;
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_OPERATING_RATE_CHANGED;
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_REUSE_NOT_IMPLEMENTED;
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_WORKAROUND;
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_NO;
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_YES_WITHOUT_RECONFIGURATION;
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_FLUSH;
import static bidmachine.media3.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_RECONFIGURATION;
import static bidmachine.media3.exoplayer.source.SampleStream.FLAG_OMIT_SAMPLE_DATA;
import static bidmachine.media3.exoplayer.source.SampleStream.FLAG_PEEK;
import static bidmachine.media3.exoplayer.source.SampleStream.FLAG_REQUIRE_FORMAT;
...
import bidmachine.media3.common.util.TimedValueQueue;
import bidmachine.media3.common.util.TraceUtil;
import bidmachine.media3.common.util.UnstableApi;
import bidmachine.media3.common.util.Util;
import bidmachine.media3.container.NalUnitUtil;
import bidmachine.media3.decoder.CryptoConfig;
import bidmachine.media3.decoder.DecoderInputBuffer;
import bidmachine.media3.decoder.DecoderInputBuffer.InsufficientCapacityException;
import bidmachine.media3.exoplayer.BaseRenderer;
import bidmachine.media3.exoplayer.DecoderCounters;
import bidmachine.media3.exoplayer.DecoderReuseEvaluation;
import bidmachine.media3.exoplayer.DecoderReuseEvaluation.DecoderDiscardReasons;
import bidmachine.media3.exoplayer.ExoPlaybackException;
import bidmachine.media3.exoplayer.FormatHolder;
import bidmachine.media3.exoplayer.analytics.PlayerId;
import bidmachine.media3.exoplayer.audio.OggOpusAudioPacketizer;
import bidmachine.media3.exoplayer.drm.DrmSession;
import bidmachine.media3.exoplayer.drm.DrmSession.DrmSessionException;
import bidmachine.media3.exoplayer.drm.FrameworkCryptoConfig;
import bidmachine.media3.exoplayer.mediacodec.MediaCodecUtil.DecoderQueryException;
import bidmachine.media3.exoplayer.source.MediaPeriod;
import bidmachine.media3.exoplayer.source.SampleStream;
import bidmachine.media3.exoplayer.source.SampleStream.ReadDataResult;
import bidmachine.media3.exoplayer.source.SampleStream.ReadFlags;
