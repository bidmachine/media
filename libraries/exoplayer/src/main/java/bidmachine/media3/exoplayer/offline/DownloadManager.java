...
import static bidmachine.media3.exoplayer.offline.Download.FAILURE_REASON_NONE;
import static bidmachine.media3.exoplayer.offline.Download.FAILURE_REASON_UNKNOWN;
import static bidmachine.media3.exoplayer.offline.Download.STATE_COMPLETED;
import static bidmachine.media3.exoplayer.offline.Download.STATE_DOWNLOADING;
import static bidmachine.media3.exoplayer.offline.Download.STATE_FAILED;
import static bidmachine.media3.exoplayer.offline.Download.STATE_QUEUED;
import static bidmachine.media3.exoplayer.offline.Download.STATE_REMOVING;
import static bidmachine.media3.exoplayer.offline.Download.STATE_RESTARTING;
import static bidmachine.media3.exoplayer.offline.Download.STATE_STOPPED;
import static bidmachine.media3.exoplayer.offline.Download.STOP_REASON_NONE;
...
import bidmachine.media3.database.DatabaseProvider;
import bidmachine.media3.datasource.DataSource;
import bidmachine.media3.datasource.DataSource.Factory;
import bidmachine.media3.datasource.cache.Cache;
import bidmachine.media3.datasource.cache.CacheDataSource;
import bidmachine.media3.datasource.cache.CacheEvictor;
import bidmachine.media3.datasource.cache.NoOpCacheEvictor;
import bidmachine.media3.exoplayer.scheduler.Requirements;
import bidmachine.media3.exoplayer.scheduler.RequirementsWatcher;
