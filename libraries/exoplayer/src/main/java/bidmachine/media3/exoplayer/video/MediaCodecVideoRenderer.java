 ...
 */
package bidmachine.media3.exoplayer.video;
...
import bidmachine.media3.common.util.MediaFormatUtil;
...
import bidmachine.media3.exoplayer.mediacodec.MediaCodecAdapter;
import bidmachine.media3.exoplayer.mediacodec.MediaCodecDecoderException;
import bidmachine.media3.exoplayer.mediacodec.MediaCodecInfo;
import bidmachine.media3.exoplayer.mediacodec.MediaCodecRenderer;
import bidmachine.media3.exoplayer.mediacodec.MediaCodecSelector;
...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
  ...
  @Override
  protected @RendererCapabilities.Capabilities int supportsFormat(MediaCodecSelector mediaCodecSelector, Format format)
    ...
    int decoderSupport = isPreferredDecoder ? RendererCapabilities.DECODER_SUPPORT_PRIMARY : RendererCapabilities.DECODER_SUPPORT_FALLBACK;
  ...
  private static final class VideoFrameProcessorManager {
    ...
    public void releaseProcessedFrames(long positionUs, long elapsedRealtimeUs) {
      ...
      while (!processedFramesTimestampsUs.isEmpty()) {
        boolean isStarted = renderer.getState() == Renderer.STATE_STARTED;
