...
import bidmachine.media3.decoder.Decoder;
...
import bidmachine.media3.exoplayer.audio.AudioRendererEventListener.EventDispatcher;
import bidmachine.media3.exoplayer.audio.AudioSink.SinkFormatSupport;
  ...
  private void maybeInitDecoder() throws ExoPlaybackException {
    ...
    if (decoderDrmSession != null) {
      ...
      if (cryptoConfig == null) {
        DrmSession.DrmSessionException drmError = decoderDrmSession.getError();
        if (drmError != null) {
