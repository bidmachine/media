...
import bidmachine.media3.common.Player.TimelineChangeReason;
...
public interface AnalyticsListener {
  ...
  final class EventTime {
    ...
    /**
     * {@link MediaSource.MediaPeriodId Media period identifier} for the media period this event belongs to, or
    ...
    /**
     * {@link MediaSource.MediaPeriodId Media period identifier} for the currently playing media period at the
     ...
     * @param mediaPeriodId {@link MediaSource.MediaPeriodId Media period identifier} for the media period this
     ...
     * @param currentMediaPeriodId {@link MediaSource.MediaPeriodId Media period identifier} for the currently
