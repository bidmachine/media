 ...
 */
package bidmachine.media3.exoplayer.offline;
...
import bidmachine.media3.exoplayer.trackselection.BaseTrackSelection;
...
import bidmachine.media3.exoplayer.trackselection.TrackSelectionUtil;
...
import bidmachine.media3.exoplayer.upstream.DefaultAllocator;
import bidmachine.media3.exoplayer.video.VideoRendererEventListener;
import bidmachine.media3.extractor.ExtractorsFactory;
import bidmachine.media3.exoplayer.trackselection.MappingTrackSelector;
...
public final class DownloadHelper {
  ...
  private TrackSelectorResult runTrackSelection(int periodIndex) throws ExoPlaybackException {
    TrackSelectorResult trackSelectorResult =
        trackSelector.selectTracks(
            ...
            new MediaSource.MediaPeriodId(mediaPreparer.timeline.getUidOfPeriod(periodIndex)),
            mediaPreparer.timeline);
  ...
  private static final class MediaPreparer
      implements MediaSource.MediaSourceCaller, MediaPeriod.Callback, Handler.Callback {
      ...
      for (int i = 0; i < mediaPeriods.length; i++) {
        MediaPeriod mediaPeriod =
            mediaSource.createPeriod(
                new MediaSource.MediaPeriodId(timeline.getUidOfPeriod(/* periodIndex= */ i)),
                allocator,
                /* startPositionUs= */ 0);
