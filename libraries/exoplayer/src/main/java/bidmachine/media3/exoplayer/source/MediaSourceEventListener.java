...
public interface MediaSourceEventListener {
   ...
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} this load belongs to. Null if the load does not
   ...
   *     corresponding {@link #onLoadStarted(int, MediaSource.MediaPeriodId, LoadEventInfo, MediaLoadData)}
   *     event.
   * @param mediaLoadData The {@link MediaLoadData} defining the data being loaded.
   */
   ...
   *
   * @param windowIndex The window index in the timeline of the media source this load belongs to.
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} the media belongs to.
   * @param mediaLoadData The {@link MediaLoadData} defining the media being discarded.
   */
  default void onUpstreamDiscarded(
      int windowIndex, MediaSource.MediaPeriodId mediaPeriodId, MediaLoadData mediaLoadData) {}
  ...
  class EventDispatcher {
     ...
     * times in any way.
     *
     * @deprecated Use {@link #withParameters(int, MediaSource.MediaPeriodId)} instead.
     */
    @Deprecated
    @CheckResult
    ...
    /** Dispatches {@link #onLoadStarted(int, MediaSource.MediaPeriodId, LoadEventInfo, MediaLoadData)}. */
    ...
    /** Dispatches {@link #onLoadCompleted(int, MediaSource.MediaPeriodId, LoadEventInfo, MediaLoadData)}. */
    ...
    /** Dispatches {@link #onLoadCanceled(int, MediaSource.MediaPeriodId, LoadEventInfo, MediaLoadData)}. */
    ...
    /**
     * Dispatches {@link #onLoadError(int, MediaSource.MediaPeriodId, LoadEventInfo, MediaLoadData, IOException,
     * boolean)}.
     */
    ...
    /** Dispatches {@link #onUpstreamDiscarded(int, MediaSource.MediaPeriodId, MediaLoadData)}. */
    ...
    /** Dispatches {@link #onDownstreamFormatChanged(int, MediaSource.MediaPeriodId, MediaLoadData)}. */
