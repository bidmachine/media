 ...
 */
package bidmachine.media3.exoplayer.source.ads;
...
import static bidmachine.media3.exoplayer.source.ads.ServerSideAdInsertionUtil.getStreamPositionUs;
...
import bidmachine.media3.exoplayer.source.EmptySampleStream;
...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource
      ...
      if (oldAdPlaybackState != null) {
        for (int adGroupIndex = adPlaybackState.removedAdGroupCount;
          ...
          if (adGroupIndex < oldAdPlaybackState.adGroupCount
              && ServerSideAdInsertionUtil.getAdCountInGroup(adPlaybackState, /* adGroupIndex= */ adGroupIndex)
                  < ServerSideAdInsertionUtil.getAdCountInGroup(oldAdPlaybackState, /* adGroupIndex= */ adGroupIndex)) {
          ...
          if (adGroup.timeUs == C.TIME_END_OF_SOURCE) {
            checkArgument(
                ServerSideAdInsertionUtil.getAdCountInGroup(adPlaybackState, /* adGroupIndex= */ adGroupIndex) == 0);
          }
        }
      }
    }
  ...
  private static long correctMediaLoadDataPositionMs(
    ...
    long correctedPositionUs =
        id.isAd()
            ? ServerSideAdInsertionUtil.getMediaPeriodPositionUsForAd(
            ...
            : ServerSideAdInsertionUtil.getMediaPeriodPositionUsForContent(
  ...
  private static final class SharedMediaPeriod implements MediaPeriod.Callback {
    ...
    public boolean canReuseMediaPeriod(MediaPeriodId id, long positionUs) {
      ...
      long previousEndPositionUs =
          ServerSideAdInsertionUtil.getStreamPositionUs(
              ...
              adPlaybackState);
      long startPositionUs = ServerSideAdInsertionUtil.getStreamPositionUs(positionUs, id, adPlaybackState);
      ...
      if (mediaLoadData != null && mediaLoadData.mediaStartTimeMs != C.TIME_UNSET) {
        for (int i = 0; i < mediaPeriods.size(); i++) {
          ...
          long startTimeInPeriodUs =
              ServerSideAdInsertionUtil.getMediaPeriodPositionUs(
    ...
    public void prepare(MediaPeriodImpl mediaPeriod, long positionUs) {
      ...
      long preparePositionUs =
          ServerSideAdInsertionUtil.getStreamPositionUs(positionUs, mediaPeriod.mediaPeriodId, adPlaybackState);
    ...
    public long seekToUs(MediaPeriodImpl mediaPeriod, long positionUs) {
      ...
      return ServerSideAdInsertionUtil.getMediaPeriodPositionUs(
    ...
    private long getStreamPositionUsWithNotYetStartedHandling(
      ...
      return ServerSideAdInsertionUtil.getStreamPositionUs(positionUs, mediaPeriod.mediaPeriodId, adPlaybackState);
    }
    ...
    private long getMediaPeriodPositionUsWithEndOfSourceHandling(
      ...
      long mediaPeriodPositionUs =
          ServerSideAdInsertionUtil.getMediaPeriodPositionUs(positionUs, mediaPeriod.mediaPeriodId, adPlaybackState);
