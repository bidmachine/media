...
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_DECODER_INITIALIZED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_DISABLED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_ENABLED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_INPUT_FORMAT_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_POSITION_ADVANCING;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_DOWNSTREAM_FORMAT_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_DRM_KEYS_LOADED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_DRM_SESSION_ACQUIRED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_DRM_SESSION_MANAGER_ERROR;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_DRM_SESSION_RELEASED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_DROPPED_VIDEO_FRAMES;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_IS_LOADING_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_IS_PLAYING_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_LOAD_COMPLETED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_LOAD_ERROR;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_LOAD_STARTED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_MEDIA_ITEM_TRANSITION;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_PLAYBACK_PARAMETERS_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_PLAYBACK_STATE_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_PLAYER_ERROR;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_PLAYER_RELEASED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_PLAY_WHEN_READY_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_POSITION_DISCONTINUITY;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_RENDERED_FIRST_FRAME;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_TIMELINE_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_TRACKS_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_DECODER_INITIALIZED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_DISABLED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_ENABLED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_FRAME_PROCESSING_OFFSET;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_INPUT_FORMAT_CHANGED;
import static bidmachine.media3.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_SIZE_CHANGED;
...
import static bidmachine.media3.test.utils.robolectric.TestPlayerRunHelper.runUntilIsLoading;
...
import bidmachine.media3.common.DrmInitData;
...
import bidmachine.media3.common.util.ConditionVariable;
...
import bidmachine.media3.exoplayer.ExoPlayer;
import bidmachine.media3.exoplayer.Renderer;
import bidmachine.media3.exoplayer.RenderersFactory;
import bidmachine.media3.exoplayer.drm.DefaultDrmSessionManager;
import bidmachine.media3.exoplayer.drm.DrmSession;
import bidmachine.media3.exoplayer.drm.DrmSessionManager;
import bidmachine.media3.exoplayer.drm.ExoMediaDrm;
import bidmachine.media3.exoplayer.drm.MediaDrmCallback;
import bidmachine.media3.exoplayer.drm.MediaDrmCallbackException;
...
import bidmachine.media3.test.utils.FakeExoMediaDrm;
...
import bidmachine.media3.test.utils.robolectric.RobolectricUtil;
